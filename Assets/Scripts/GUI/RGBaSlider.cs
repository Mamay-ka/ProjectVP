...
public class RGBaSlider : MonoBehaviour
{
    ...
    void OnGUI()
    {
        mySlider = LabelSlider(new Rect(10, 10, 200, 20), mySlider, 0.5f, 5.0f, "My Slider"); // Отрисовка пользовательского слайдера
        ...
        //mySlider = LabelSlider(new Rect(10, 120, 200, 20), mySlider, 5.0f, "Learning Aim Slider");//учусь создавать свой слайдер.
    }
